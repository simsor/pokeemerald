...
const u8 gText_BirchBoy[] = _("GARCON");
...
const u8 gText_CanIHelpWithAnythingElse[] = _("Je peux faire quelque chose d'autre?");
...
const u8 gText_HP3[] = _("PC");
const u8 gText_SpAtk3[] = _("ATQ SP");
const u8 gText_SpDef3[] = _("DEF SP");
...
const u8 gText_Rooftop[] = _("TOIT"); // ROOFTOP
...
const u8 gText_Protein1000[] = _("PROTEINE{CLEAR_TO 99}{FONT_SMALL}1,000");
...
const u8 gText_HPUp1000[] = _("PV PLUS{CLEAR_TO 99}{FONT_SMALL}1,000");
const u8 gText_PPUp3000[] = _("PP PLUS{CLEAR_TO 99}{FONT_SMALL}3,000");
...
const u8 gPCText_Switch[] = _("CHANGER");
...
const u8 gPCText_Beach[] = _("PLACE");
...
const u8 gText_MoveItems[] = _("DEPLACER ITEMS");
...
const u8 gText_Detail[] = _("DETAILS");
const u8 gText_Call2[] = _("APPELS"); 
const u8 gText_UnusedExit[] = _("RETOUR"); 
const u8 gText_CantCallOpponentHere[] = _("Impossible d'appeler d'ici."); // Unused
...
const u8 gText_FrameType[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}TYPE "); // TODO: figure out how to separate Type from number
